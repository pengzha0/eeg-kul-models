...
class Inception(nn.Module):
    def __init__(self, in_channels, n_filters, kernel_sizes=[3, 19, 39], bottleneck_channels=32, activation=nn.ReLU(),
                 return_indices=False, total_class=2):
        """
...
def INCEPTION(channels_num, sample_len):
    return Inception(channels_num,256)

if __name__ == '__main__':
    model = Inception(4560, 256).cuda()
